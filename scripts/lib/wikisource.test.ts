...
describe("sectionOf / joinNumberedVerses", () => {
  ...
  it("does not glue an unnumbered ಸೂಚನೆ onto verse 1, and keeps its closing line", () => {
    const text = "ಸೂಚನೆ: ಈ ಪದ್ಯವನ್ನು ಹಾಡುವುದು ||\nಕೇಳು ಜನಮೇಜಯ\nಶೀಲವನು ರಾಗದಲಿ ೧";
    expect(joinNumberedVerses(text)).toBe("ಸೂಚನೆ: ಈ ಪದ್ಯವನ್ನು ಹಾಡುವುದು ||\n\nಕೇಳು ಜನಮೇಜಯ\nಶೀಲವನು ರಾಗದಲಿ ೧");
  });

  it("keeps verse lines that end in a bare || or ॥ with no verse number (C-26)", () => {
    const text = [
      "ಹರಿಕಥಾಮೃತಸಾರ ಗುರುಗಳ |", "ಕರುಣದಿಂದಾಪನಿತು ಪೇಳುವೆ |", "ಪರಮಭಗವದ್ಭಕ್ತರಿದನಾದರದಿ ಕೇಳುವುದು ||",
      "ಕೇಳು ಜನಮೇಜಯ ಧರಿತ್ರೀ", "ಪಾಲ ಕುಂತೀಭೋಜ ಭೂಪತಿ", "ಯಾಲಯದೊಳೀ ಕುಂತಿ ಮೆರೆದಳು ವಿವಿಧ ವಿಭವದಲಿ||",
      "ಕೇಳಿದನು ಗಾಂಗೇಯನಾ ನೀ", "ಶೀಲವನು ರಾಗದಲಿ || ೧ ||",
      "ಕೃತಿರಮಣ ಪ್ರದ್ಯುಮ್ನನಂದನೆ", "ವತೆಗಳಿಗೆ ಗುರುವೆನಿಸುತಿಹ ಮಾರುತನ ನಿಜಪತ್ನಿ ॥", "ಸತತ ಹರಿಯಲಿ ಗುರುಗಳಲಿ ॥೨॥",
    ].join("\n\n");
    expect(joinNumberedVerses(text).split("\n\n")).toEqual([
      "ಹರಿಕಥಾಮೃತಸಾರ ಗುರುಗಳ |\nಕರುಣದಿಂದಾಪನಿತು ಪೇಳುವೆ |\nಪರಮಭಗವದ್ಭಕ್ತರಿದನಾದರದಿ ಕೇಳುವುದು ||",
      "ಕೇಳು ಜನಮೇಜಯ ಧರಿತ್ರೀ\nಪಾಲ ಕುಂತೀಭೋಜ ಭೂಪತಿ\nಯಾಲಯದೊಳೀ ಕುಂತಿ ಮೆರೆದಳು ವಿವಿಧ ವಿಭವದಲಿ||\nಕೇಳಿದನು ಗಾಂಗೇಯನಾ ನೀ\nಶೀಲವನು ರಾಗದಲಿ || ೧ ||",
      "ಕೃತಿರಮಣ ಪ್ರದ್ಯುಮ್ನನಂದನೆ\nವತೆಗಳಿಗೆ ಗುರುವೆನಿಸುತಿಹ ಮಾರುತನ ನಿಜಪತ್ನಿ ॥\nಸತತ ಹರಿಯಲಿ ಗುರುಗಳಲಿ ॥೨॥",
    ]);
  });
});
