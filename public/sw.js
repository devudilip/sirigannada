 ...
 */
const SHELL_CACHE = "sg-shell-v11";
// Keep DATA_CACHE in lockstep with src/lib/cacheNames.ts (enforced by cacheNames.test.ts).
const DATA_CACHE = "sg-data-v5";
const PRECACHE_SHELL = ["/", "/dictionary", "/library", "/about", "/credits", "/contact", "/tools", "/tools/transliterate", "/tools/numbers", "/tools/convert", "/tools/text-health", "/tools/offline", "/more", "/collections", "/learn", "/learn/alphabet", "/learn/practice", "/games", "/games/word", "/games/padabandha", "/proverbs", "/stories", "/manifest.webmanifest", "/favicon.svg"];
const PRECACHE_DATA = ["/data/books/manifest.json", "/data/dict/manifest.json", "/data/dict/wordgame.json", "/data/dict/padabandha.json", "/data/proverbs.json", "/data/stories/manifest.json"];
