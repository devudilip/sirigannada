...
const PRECACHE_SHELL = ["/", "/dictionary", "/library", "/about", "/credits", "/tools", "/tools/transliterate", "/tools/numbers", "/tools/convert", "/learn", "/learn/alphabet", "/proverbs", "/manifest.webmanifest", "/favicon.svg"];
