...
export function PicturebookContinue({ book, progress }: { book: PictureBookMeta; progress: PicturebookProgress }) {
  ...
  return (
    <section aria-labelledby="picturebooks-continue">
      ...
      <Card className="grid grid-cols-[100px_1fr] items-center gap-5 p-4">
        <span className="block aspect-[4/5] overflow-hidden rounded-lg bg-elevated border border-line">
        ...
        <div className="min-w-0 flex flex-col gap-3">
          ...
          <LinkButton href={`/picturebooks/${book.slug}`} size="lg" className="h-13 px-6 text-lg self-start">
            <PlayIcon size={20} />
