...
export function LogoMark({ size = 32, variant = "full" }: { size?: number; variant?: "full" | "mono" }) {
  ...
  const bar = withBar ? <rect x="96" y="410" width="320" height="24" /> : null;
