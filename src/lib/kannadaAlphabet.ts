 ...
 * both the learn/alphabet page and the learn/practice quiz feature need it — see src/lib/speak.ts
 * for the precedent of promoting a learn/-only helper once a second feature needed it.
 */
