...
export const strings = {
  ...
  toolsSub: {
    kn: "ಲಿಪ್ಯಂತರ, ಅಂಕೆಗಳು, ನುಡಿ/ಬರಹ, ವರ್ಣಮಾಲೆ, ಗಾದೆಗಳು.",
    en: "Transliteration, numbers, Nudi/Baraha, alphabet, proverbs.",
  },
  ...
  alphabetSub: {
    kn: "ಕನ್ನಡದ ಸ್ವರ, ವ್ಯಂಜನ, ಕಾಗುಣಿತ ಮತ್ತು ಒತ್ತಕ್ಷರ. ಪ್ರತಿ ಅಕ್ಷರಕ್ಕೆ ISO 15919 ಲಿಪ್ಯಂತರ.",
    en: "Kannada vowels, consonants, gunitakshara, and conjuncts, each with ISO 15919.",
  },
  ...
  alphabetGunitaHint: {
    kn: "ಒಂದು ವ್ಯಂಜನವನ್ನು ಆರಿಸಿ. ಸ್ವರ ಚಿಹ್ನೆಗಳು ಅದಕ್ಕೆ ಹೇಗೆ ಸೇರುತ್ತವೆ ಎಂದು ನೋಡಿ.",
    en: "Pick a consonant to see it with every vowel sign.",
  },
  alphabetPickConsonant: { kn: "ವ್ಯಂಜನ ಆಯ್ಕೆ", en: "Choose a consonant" },
  alphabetOttakshara: { kn: "ಒತ್ತಕ್ಷರ", en: "Ottakshara" },
  alphabetOttaksharaSub: {
  ...
  proverbCredit: {
    kn: "ಕನ್ನಡ ವಿಕಿಕೋಟ್ ಸಂಪಾದಕರು. ಪರವಾನಗಿ CC BY-SA 4.0. ಇದೇ ಪರವಾನಗಿಯಲ್ಲಿ ಹಂಚಬಹುದು.",
    en: "Kannada Wikiquote contributors. Licence CC BY-SA 4.0; share-alike applies.",
  },
  proverbLoadError: { kn: "ಗಾದೆಗಳು ಲೋಡ್ ಆಗಲಿಲ್ಲ", en: "Could not load proverbs" },
  convertTitle: { kn: "ನುಡಿ / ಬರಹ", en: "Nudi / Baraha" },
  convertSub: {
    kn: "ಲ್ಯಾಟಿನ್ ASCII ಫಾಂಟ್ ಪಠ್ಯವನ್ನು ಯುನಿಕೋಡ್ ಕನ್ನಡಕ್ಕೆ ಪರಿವರ್ತಿಸಿ.",
    en: "Convert Latin ASCII font text to Unicode Kannada.",
  },
  ...
  convertNote: {
    kn: "ನುಡಿ/ಬರಹ ASCII ಫಾಂಟ್ ಎನ್‌ಕೋಡಿಂಗ್. ಇಂಗ್ಲಿಷ್ ಪದಗಳನ್ನು $...$ ನಡುವೆ ಇರಿಸಿ.",
    en: "Nudi/Baraha ASCII font encoding. Wrap English words in $...$.",
  },
